...
<form action="" method="post">
    ...
    <div class="row">
        ...
        <div class="col-4 mt-2">
            ...
            <input type="text" class="form-control" name="code" id="code" placeholder="Nhập mã sản phẩm (6 số) ..." minlength="6" maxlength="6">
        </div>
        <div class="col-4 mt-2">
                    ...
                    <div class="mb-3">
                        <div class="row align-items-end">
                            <div class="col-7">
                                ...
                                <input type="text" name="gallery[]" class="form-control" placeholder="Đường dẫn ảnh ..." id="gallery_1" value="">
                            </div>
                    ...
                    <div class="mb-3">
                        <div class="row align-items-end">
                            <div class="col-7">
                                ...
                                <input type="text" name="gallery[]" class="form-control" placeholder="Đường dẫn ảnh ..." id="gallery_2" value="">
                            </div>
                            <div class="col-2 d-grid">
                    ...
                    <div class="mb-3">
                        <div class="row align-items-end">
                            <div class="col-7">
                                ...
                                <input type="text" name="gallery[]" class="form-control" placeholder="Đường dẫn ảnh ..." id="gallery_3" value="">
                            </div>
                            <div class="col-2 d-grid">
